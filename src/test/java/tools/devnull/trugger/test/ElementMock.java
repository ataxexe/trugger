...
import tools.devnull.trugger.util.mock.Mock;
...
import static tools.devnull.trugger.util.mock.Mock.annotation;
 ...
 * @see tools.devnull.trugger.util.mock.Mock#mock(tools.devnull.trugger.util.mock.MockBuilder)
 * @since 2.0
 */
public class ElementMock implements MockBuilder<Element> {
   ...
   * created by {@link tools.devnull.trugger.util.mock.AnnotationMock}.
   *
   * @param type
   *          the annotation type.
   * @return a reference to this object.
