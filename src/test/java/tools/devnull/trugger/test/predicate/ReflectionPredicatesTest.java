 ...
 */
package tools.devnull.trugger.test.predicate;
...
import static tools.devnull.trugger.reflection.ReflectionPredicates.getterOf;
import static tools.devnull.trugger.reflection.ReflectionPredicates.setterOf;
import static tools.devnull.trugger.test.TruggerTest.assertMatch;
import static tools.devnull.trugger.test.TruggerTest.assertNotMatch;
