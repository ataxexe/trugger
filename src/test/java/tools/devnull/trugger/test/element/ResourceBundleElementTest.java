...
import static tools.devnull.trugger.test.TruggerTest.assertElements;
import static tools.devnull.trugger.test.TruggerTest.assertThrow;
...
public class ResourceBundleElementTest {
  ...
  public void bundleElementsTest() {
    final ResourceBundle bundle1 = ResourceBundle.getBundle("tools.devnull.trugger.test.element.bundle1");
    final ResourceBundle bundle2 = ResourceBundle.getBundle("tools.devnull.trugger.test.element.bundle2");
