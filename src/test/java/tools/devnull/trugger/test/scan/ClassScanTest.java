 ...
 */
package tools.devnull.trugger.test.scan;
...
import tools.devnull.trugger.test.TruggerTest;
import org.junit.Test;

import java.util.Set;

import static java.lang.reflect.Modifier.PUBLIC;
import static tools.devnull.trugger.reflection.ClassPredicates.declare;
import static tools.devnull.trugger.scan.ClassScan.findAll;
import static tools.devnull.trugger.scan.ClassScan.findAnnotations;
import static tools.devnull.trugger.scan.ClassScan.findClasses;
import static tools.devnull.trugger.scan.ClassScan.findEnums;
import static tools.devnull.trugger.scan.ClassScan.findInterfaces;
...
public class ClassScanTest {
  ...
  private String filePackageName = "tools.devnull.trugger.test.scan.classes";
  ...
  public void testEqualsAndHash() {
    PackageScan scan1 = new PackageScan("tools.devnull.trugger", ScanLevel.PACKAGE);
    PackageScan scan2 = new PackageScan("tools.devnull.trugger", ScanLevel.SUBPACKAGES);

    assertFalse(scan1.equals(scan2));
    assertFalse(scan1.hashCode() == scan2.hashCode());

    scan1 = new PackageScan("tools.devnull.trugger", ScanLevel.PACKAGE);
    scan2 = new PackageScan("tools.devnull", ScanLevel.PACKAGE);

    assertFalse(scan1.equals(scan2));
    assertFalse(scan1.hashCode() == scan2.hashCode());

    scan2 = new PackageScan("tools.devnull.trugger", ScanLevel.PACKAGE);
  ...
  public void testClassScanPacakgeInFile() {
    ...
    assertTrue(set.contains(tools.devnull.trugger.test.scan.classes.MyClass.class));
  ...
  public void testAnnotationScanPacakgeInFile() {
    ...
    assertEquals(1, set.size());
    assertTrue(set.contains(tools.devnull.trugger.test.scan.classes.MyAnnotation.class));
    assertMatch(set, filePackagePredicate);
  }
  ...
  public void testEnumScanPacakgeInFile() {
    ...
    assertEquals(1, set.size());
    assertTrue(set.contains(tools.devnull.trugger.test.scan.classes.MyEnum.class));
    assertMatch(set, filePackagePredicate);
  }
  ...
  public void testInterfaceScanPacakgeInFile() {
    ...
    assertEquals(1, set.size());
    assertTrue(set.contains(tools.devnull.trugger.test.scan.classes.MyInterface.class));
    assertMatch(set, filePackagePredicate);
  }
  ...
  public void testClassScanSubPacakgeInFile() {
    ...
    assertTrue(set.contains(tools.devnull.trugger.test.scan.classes.MyClass.class));
    assertTrue(set.contains(tools.devnull.trugger.test.scan.classes.pack.MyClass2.class));
  ...
  public void testAnnotationScanSubPacakgeInFile() {
    ...
    assertEquals(2, set.size());
    assertTrue(set.contains(tools.devnull.trugger.test.scan.classes.MyAnnotation.class));
    assertTrue(set.contains(tools.devnull.trugger.test.scan.classes.pack.MyAnnotation2.class));
  ...
  public void testClassEnumSubPacakgeInFile() {
    ...
    assertEquals(2, set.size());
    assertTrue(set.contains(tools.devnull.trugger.test.scan.classes.MyEnum.class));
    assertTrue(set.contains(tools.devnull.trugger.test.scan.classes.pack.MyEnum2.class));
  ...
  public void testInterfaceScanSubPacakgeInFile() {
    ...
    assertEquals(2, set.size());
    assertTrue(set.contains(tools.devnull.trugger.test.scan.classes.MyInterface.class));
    assertTrue(set.contains(tools.devnull.trugger.test.scan.classes.pack.MyInterface2.class));
